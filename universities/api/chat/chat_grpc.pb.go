...
const (
	...
	Chat_Attach_FullMethodName            = "/Chat/Attach"
	Chat_Create_FullMethodName            = "/Chat/Create"
	Chat_List_FullMethodName              = "/Chat/List"
	Chat_GetMessageHistory_FullMethodName = "/Chat/GetMessageHistory"
)
...
func (c *chatClient) Attach(ctx context.Context, in *AttachRequest, opts ...grpc.CallOption) (Chat_AttachClient, error) {
	stream, err := c.cc.NewStream(ctx, &Chat_ServiceDesc.Streams[0], Chat_Attach_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *chatClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (Chat_ListClient, error) {
	stream, err := c.cc.NewStream(ctx, &Chat_ServiceDesc.Streams[1], Chat_List_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
