...
import (
	...
	srv "file-service/internal/handler/grpc"
	"file-service/internal/interceptors"
	"fmt"
...
func (a *App) Run() {
	...
	s := grpc.NewServer(grpc.StreamInterceptor(interceptors.LoggingInterceptor(a.log)))
	reflection.Register(s)
	uploader.RegisterUploaderServer(s, a.impl)
